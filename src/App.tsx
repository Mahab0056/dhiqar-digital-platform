...
function LoginPage() {
  const options = [
    ...
    },
    {
      icon: Building2,
      title: 'بوابة الموظف',
      text: 'قائمة معاملات ومراجعة ضمن الصلاحية الوظيفية',
      href: '/employee',
      tone: 'employee',
    },
    {
    ...
    },
    {
      icon: ShieldCheck,
      title: 'إدارة المنصة',
      text: 'حوكمة المنصة وسجل الإجراءات',
...
const onboardingPathForService = (serviceKey: string) =>
...
function App() {
  return (
    <Switch>
      ...
      <Route path="/citizen/application/:reference">{params => <ApplicationPage reference={params.reference} />}</Route>
