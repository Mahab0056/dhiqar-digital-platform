      ...
      <WorkspaceTabs
        ...
        tabs={[
          ...
          },
          {
            ...
            label: 'معاملات إجازة المحل',
            icon: FileText,
            badge: workQueue.applications,
            content: (
              <>
                          ...
                          {selected.attachments.length === 0 ? (
                            <div className="review-document empty">
                              ...
                              <div>
                                ...
                                <small>
                                  هذه معاملة سابقة لم تحفظ مرفقات التوثيق. اطلب استكمال فيديو الوجه قبل اعتمادها.
                                </small>
                              </div>
                            </div>
                          ) : (
                        ...
                        {missingFaceVerification && (
                          <div className="review-verification-required">
                            ...
                            <span>
                              ...
                              <small>
                                لم يُحفظ فيديو توثيق الوجه مع الطلب. اضغط «طلب استكمال التوثيق» ليصل للمواطن إشعار ورابط
                                تصوير الفيديو.
                              </small>
                            </span>
                          </div>
