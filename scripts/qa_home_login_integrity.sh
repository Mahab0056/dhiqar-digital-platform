...
for target in '/#services' '/citizen' '/service/online-appointment' '/service/water-complaint' '/verify' '/onboarding' '/employee' '/operations/login' '/super-admin/login'; do
