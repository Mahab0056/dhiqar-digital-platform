...
const app3 = await ctx.request.post(`${base}/api/applications`, {
  multipart: {
    ...
    businessName: 'مكتب الأمانة للخدمات',
    activityType: 'مكتب خدمات',
    address: 'حي الجامعة، شارع 40',
    district: 'الشطرة',
    ownershipType: 'owned',
...
const a3 = await app3.json()
console.log('app3', app3.status(), a3.reference || a3.message)
const sa = await browser.newContext()
await sa.request.post(`${base}/api/auth/staff/login`, {
